        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-stretch">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Email Card (Dark) */}
              <div className="bg-[#111827] text-white p-6 rounded-2xl flex items-center gap-4 hover:scale-[1.02] transition-transform cursor-pointer">
                <div className="w-12 h-12 rounded-full bg-[#00529C] flex items-center justify-center text-white">
                  <Mail className="w-5 h-5" />
                </div>
                <div>
                  <div className="text-sm font-bold">Email</div>
                  <div className="text-xs text-slate-400">rirusulut@gmail.com</div>
                </div>
              </div>
